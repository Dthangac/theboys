...
const ImageList = [
  {
    ...
    price: "12.99",
    tag: "Mới",
    title: "Đồng Hồ Màu Xanh Thế Hệ Tiếp Theo",
    description:
      "Đồng Hồ Thông Minh Ultra 2 Của Apple là sản phẩm mới nhất, được giảm giá và rất nổi bật trong thời gian gần đây. Sản phẩm này có giá 14.99 và được đánh giá rất cao từ người dùng.",
  },
  {
    id: 2,
    img: watch2,
    price: "13.99",
    tag: "Giảm Giá",
    title: "Đồng Hồ Màu Vàng Thông Minh Nhất",
    description:
      "Đồng Hồ Thông Minh Ultra 2 Của Apple là sản phẩm mới nhất, được giảm giá và rất nổi bật trong thời gian gần đây. Sản phẩm này có giá 14.99 và được đánh giá rất cao từ người dùng.",
  },
  {
    ...
    price: "14.99",
    tag: "Nóng",
    title: "Đồng Hồ Thông Minh Ultra 2 Của Apple",
    description:
      "Đồng Hồ Thông Minh Ultra 2 Của Apple là sản phẩm mới nhất, được giảm giá và rất nổi bật trong thời gian gần đây. Sản phẩm này có giá 14.99 và được đánh giá rất cao từ người dùng.",
  },
];
...
const Hero = () => {
  ...
  const [title, setTitle] = React.useState("Sản Phẩm Kỹ Thuật Số Tốt Nhất & Thông Minh");
